...
import corn_test.petstore_test.utils.SpeakeasyHTTPClient;
...
public class PetstoreTest {
	...
	public static class Builder {
		...
		public Builder setServerURL(String serverUrl, java.util.Map<String, String> params) {
			this.sdkConfiguration.serverUrl = corn_test.petstore_test.utils.Utils.templateUrl(serverUrl, params);
			return this;
		}
		 ...
		 */
		public PetstoreTest build() throws Exception {
			...
			return new PetstoreTest(this.sdkConfiguration);
		}
	}
	...
	private PetstoreTest(SDKConfiguration sdkConfiguration) throws Exception {
